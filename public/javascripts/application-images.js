function CreateButtons(series){
    ...
    for (var i in series.Images.Images) {
        buttons = "<button type=\"button\" onclick=\"$.ajax({url: '/api/images/del/"+series.Images.Images[i].Id+"',type: 'GET',dataType: 'json'})\" data-loading-text=\"Removing...\" class=\"btn btn-primary btn-del-img\">Remove</button>"
